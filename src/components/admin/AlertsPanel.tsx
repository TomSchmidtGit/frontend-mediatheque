        ...
        <div className='bg-white rounded-xl border border-gray-200 p-6'>
          ...
          <div className='space-y-3'>
            {Array.from({ length: 3 }).map((_, index) => (
              <div
                key={index}
                className='flex items-start space-x-3 p-3 border border-gray-200 rounded-lg animate-pulse'
              >
      ...
      <div className='bg-white rounded-xl border border-gray-200 overflow-hidden'>
        <div className='px-6 py-4 border-b border-gray-200'>
          <h3 className='text-lg font-semibold text-gray-900 flex items-center'>
            ...
            Alertes système
            {stats.alerts.filter(alert => alert.priority === 'high').length >
              0 && (
                ...
                return (
                  ...
                  >
                    <AlertIcon
                      className={cn(
                        'h-5 w-5 mt-0.5',
                        getIconColor(alert.type, alert.priority)
                      )}
                    />
                    <div className='flex-1'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='text-right'>
                      <p className='text-sm font-bold text-red-600'>
                        {overdue.daysOverdue} jour
                        {overdue.daysOverdue > 1 ? 's' : ''}
                      </p>
