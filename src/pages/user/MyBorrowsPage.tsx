...
const MyBorrowsPage: React.FC = () => {
  const metaTags = generateMetaTags('myBorrows');
  const { user } = useAuth();
              ...
              <div className='flex items-center justify-between'>
                <div>
                  <p className='text-2xl font-bold text-blue-600'>
                    {
                      displayData.data.filter(b => b.status === 'borrowed')
                        .length
                    }
                  </p>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  <p className='text-2xl font-bold text-green-600'>
                    {
                      displayData.data.filter(b => b.status === 'returned')
                        .length
                    }
                  </p>
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <ul className='text-sm text-primary-800 space-y-1'>
                  ...
                  <li>
                    • Vous recevrez des rappels par email 2 jours avant
                    l'échéance
                  </li>
                  <li>
