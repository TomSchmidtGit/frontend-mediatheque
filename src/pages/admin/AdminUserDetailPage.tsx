  ...
  return (
    <div className='bg-gray-50 min-h-screen'>
                        ...
                        <div className='flex items-start justify-between'>
                          <div className='flex items-start space-x-3'>
                            ...
                            <div className='flex-1'>
                              ...
                              <div className='flex items-center space-x-4 text-sm text-gray-500'>
                                ...
                                <span>
                                  À rendre le {formatDate.short(borrow.dueDate)}
                                </span>
                                {borrow.returnDate && (
                          ...
                          <div className='flex flex-col items-end space-y-2'>
                            ...
                            <span
                              className={cn(
                                'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium',
                                borrow.media.type === 'book'
                                  ? 'bg-blue-100 text-blue-800'
                                  : borrow.media.type === 'movie'
                    ...
                    {user.favorites.slice(0, 6).map((favorite, index) => (
                      ...
                      >
                        ...
                        <p className='text-sm text-gray-600'>
                          {typeof favorite === 'object' && 'title' in favorite
                            ? (favorite as any).title
                            : 'Média favori'}
                        </p>
                        <p className='text-xs text-gray-500'>
                          {typeof favorite === 'object' && 'author' in favorite
                            ? (favorite as any).author
                            : `ID: ${favorite}`}
                        </p>
                      </div>
                    ))}
      ...
      <ConfirmDialog
        ...
        title={
          user.actif ? 'Confirmer la désactivation' : "Confirmer l'activation"
        }
