          ...
          <div className='flex items-start'>
            ...
            <div>
              ...
              <ul className='text-sm text-blue-800 space-y-1'>
                <li>
                  • Veillez à bien remplir tous les champs lors de l'ajout d'un
                  média
                </li>
                <li>
                ...
                <li>
                  • Assignez des catégories et tags pertinents pour faciliter la
                  recherche
                </li>
                <li>
                  • Surveillez les médias les plus empruntés pour ajuster votre
                  collection
                </li>
                <li>
