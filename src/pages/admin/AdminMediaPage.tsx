            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{mediaStats.total}</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{mediaStats.available}</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">{mediaStats.borrowed}</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{mediaStats.byType.book}</p>
                </div>
                <BookOpenIcon className="h-8 w-8 text-blue-500" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">
                {isLoading ? 'Chargement...' : (
                  <>
                    {mediaData?.totalItems || 0} média{(mediaData?.totalItems || 0) > 1 ? 's' : ''} trouvé{(mediaData?.totalItems || 0) > 1 ? 's' : ''}
                  </>
                )}
              </h2>
              
              <div className="text-sm text-gray-500">
                Page {mediaData?.currentPage || 1} sur {mediaData?.totalPages || 1}
              </div>
            </div>
          </div>
